  ...
  var HUBS = [
    { id:"ordering", label:"Online Ordering", icon:"🛒", accent:"#e07b00",
      ...
      href:"/admin/hub.html?cat=ordering", tools:[
        ...
        { href:"https://hcpsonlineordering.netlify.app/admin/product-content-review.html", label:"Product Content Enrichment & Review", icon:"🔬", status:"new", desc:"Merge website + PDF + HCPS content, pick the best version & approve before dealers see it" },
